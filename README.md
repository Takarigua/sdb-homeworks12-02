# Домашнее задание к занятию "Работа с данными (DDL/DML)" - `Марченко Вячеслав Игоревич`
...
3. Переподключился и используя (перед этим копирнул её) mysql -usys_temp -pyour_password sakila < /sakila-schema.sql и mysql -usys_temp -pyour_password sakila < /sakila-data.sql восстановил базу
